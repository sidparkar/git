...
<!-- Mirrored from wptheme.co.in/classified_html/dashboard_my_searches.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 06 Sep 2018 06:10:15 GMT -->
<head>
<meta charset="utf-8"/>
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<title>Dashboard My Searches</title>
					...
					<div class="inner-search">
						...
						<div class="row">
							<div class="col-sm-6 col-xs-12">
								<div class="box">
									<div class="image"><img src="images/vehicle/icons8-motorcycle.png" alt="image" title="image" class="img-responsive"></div>
									<div class="pull-left">
										<h4>Vehicle <i class="la la-angle-double-right"></i> Bikes</h4>
										<ul class="list-inline">
											<li><i class="la la-map-marker"></i> Ludhiana, Punjab, India</li>
											<li><i class="la la-clock-o"></i> 2.45 pm</li>
										</ul>
							...
							<div class="col-sm-6 col-xs-12">
								<div class="box">
									<div class="image"><img src="images/mobile/smartphone-tablet.png" alt="image" title="image" class="img-responsive"></div>
									<div class="pull-left">
										<h4>Mobile <i class="la la-angle-double-right"></i> Iphones</h4>
										<ul class="list-inline">
											<li><i class="la la-map-marker"></i> Ludhiana, Punjab, India</li>
											<li><i class="la la-clock-o"></i> 2.45 pm</li>
										</ul>
							...
							<div class="col-sm-6 col-xs-12">
								<div class="box">
									<div class="image"><img src="images/electronics/globe-bulb.png" alt="image" title="image" class="img-responsive"></div>
									<div class="pull-left">
										<h4>Electonices <i class="la la-angle-double-right"></i> TVs</h4>
										<ul class="list-inline">
											<li><i class="la la-map-marker"></i> Ludhiana, Punjab, India</li>
											<li><i class="la la-clock-o"></i> 2.45 pm</li>
										</ul>
							...
							<div class="col-sm-6 col-xs-12">
								<div class="box">
									<div class="image"><img src="images/jobs/icon-briefcase.png" alt="image" title="image" class="img-responsive"></div>
									<div class="pull-left">
										<h4>Jobs <i class="la la-angle-double-right"></i> Accountant</h4>
										<ul class="list-inline">
											<li><i class="la la-map-marker"></i> Ludhiana, Punjab, India</li>
											<li><i class="la la-clock-o"></i> 2.45 pm</li>
										</ul>
							...
							<div class="col-sm-6 col-xs-12">
								<div class="box">
									<div class="image"><img src="images/real-estate/building.png" alt="image" title="image" class="img-responsive"></div>
									<div class="pull-left">
										<h4>Real Estate <i class="la la-angle-double-right"></i> Apartments</h4>
										<ul class="list-inline">
											<li><i class="la la-map-marker"></i> Ludhiana, Punjab, India</li>
											<li><i class="la la-clock-o"></i> 2.45 pm</li>
										</ul>
							...
							<div class="col-sm-6 col-xs-12">
								<div class="box">
									<div class="image"><img src="images/pets/dog.png" alt="image" title="image" class="img-responsive"></div>
									<div class="pull-left">
										<h4>Pets <i class="la la-angle-double-right"></i> Dogs</h4>
										<ul class="list-inline">
											<li><i class="la la-map-marker"></i> Ludhiana, Punjab, India</li>
											<li><i class="la la-clock-o"></i> 2.45 pm</li>
										</ul>
							...
							<div class="col-sm-6 col-xs-12">
								<div class="box">
									<div class="image"><img src="images/furniture/icon-chair.png" alt="image" title="image" class="img-responsive"></div>
									<div class="pull-left">
										<h4>Furniture <i class="la la-angle-double-right"></i> Sofa</h4>
										<ul class="list-inline">
											<li><i class="la la-map-marker"></i> Ludhiana, Punjab, India</li>
											<li><i class="la la-clock-o"></i> 2.45 pm</li>
										</ul>
							...
							<div class="col-sm-6 col-xs-12">
								<div class="box">
									<div class="image"><img src="images/fashion/trainers.png" alt="image" title="image" class="img-responsive"></div>
									<div class="pull-left">
										<h4>Fashion <i class="la la-angle-double-right"></i> Shoes</h4>
										<ul class="list-inline">
											<li><i class="la la-map-marker"></i> Ludhiana, Punjab, India</li>
											<li><i class="la la-clock-o"></i> 2.45 pm</li>
										</ul>
