				...
				<div class="col-md-6 col-sm-6 col-xs-12 bor">
					...
					<form method="post" enctype="multipart/form-data" id="commentForm" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
						<div class="form-group">
							...
							<select required class="form-control" name="user_profile">	
						...
						<div class="form-group">
							<i class="la la-user"></i><input type="text" name="username" value="" placeholder="Username" id="input-username" class="form-control" required>
							<?php echo $errName; ?>
						</div>
