...
$row=$res->fetch_assoc();
	...
	if(isset($_POST['submit'])){
		...
		$user_eating = addslashes($_POST["A"]);
		$user_drinking = addslashes($_POST["B"]);
		$user_smoking = addslashes($_POST["C"]);
		$user_disability = addslashes($_POST["D"]);
		$user_star = $_POST["star"];
		$user_rashi = $_POST["rashi"];
		$user_dosh = addslashes($_POST['J']);
		...
		$user_income = addslashes($_POST["income"]);
		$user_employed = addslashes($_POST["E"]);
		...
		$user_origin = $_POST["family_origin"];
		$user_fstatus = addslashes($_POST["G"]);
		$user_ftype = addslashes($_POST["H"]);
		$user_fvalues = addslashes($_POST["I"]);
		$user_about = $_POST["about"];

	$sql = "INSERT INTO user_info(user_id,image,profile_for,height,user_age, user_weight,caste,sub_caste,eating_habits,drinking_habits,smoking_habits,disability,star,rashi,manglik,birth_time,birth_minute,birth_period,birth_place,birth_city,education,occupation,currency,income,employed_in,father_status,mother_status,brother_status,sister_status,phone,family_status,family_type,family_values,about_user)
			VALUES('$user_id','$image','$user_martial','$user_height','$user_age','$user_weight','$user_caste','$user_subcaste','$user_eating','$user_drinking','$user_smoking','$user_disability','$user_star','$user_rashi','$user_dosh','$user_birthtime','$user_birthminute','$user_birthperiod','$user_birthplace','$user_birthcity','$user_education','$user_occupation','$user_currency','$user_income','$user_employed','$user_father','$user_mother','$user_brother','$user_sister','$user_phone','$user_fstatus','$user_ftype','$user_fvalues','$user_about');";
			...
			if(!$res){
				...
				window.location.href='partner-preference.php';
				</script>";
			}
 	}
	?>
						...
						<div class="terms">
							...
							<div class="mainbox">
									...
									<div class="paddright ">
											...
											<div class="paddright">
												<div class="col-md-2 col-sm-12 col-xs-12"><span> Martial status</span></div>
												<div class="col-md-10 col-sm-12 col-xs-12 input-padding">
													<select required class="selectpicker form-control" name="martial_status" >
			                      ...
			                      <option value="Divorce">Divorce</option>
											...
											<div class="paddright">
												...
												<div class="col-md-10 input-padding">
													<select required class="selectpicker form-control" name="height">
                    <option value="">Choose Height</option>
                    <option value="4ft 0in/121.92cm">4ft 0in/121.92cm</option>
                    <option value="4ft 1in/124.46cm">4ft 1in/124.46cm</option>
                    <option value="4ft 2in/127.00cm">4ft 2in/127.00cm</option>
                    <option value="4ft 3in/129.54cm">4ft 3in/129.54cm</option>
                    <option value="4ft 3in/132.04cm">4ft 4in/132.08cm</option>
                    <option value="4ft 5in/134.62cm">4ft 5in/134.62cm</option>
                    <option value="4ft 6in/137.16cm">4ft 6in/137.16cm</option>
                    <option value="4ft 7in/139.70cm">4ft 7in/139.70cm</option>
                    <option value="4ft 8in/142.24cm">4ft 8in/142.24cm</option>
                    <option value="4ft 9in/144.78cm">4ft 9in/144.78cm</option>
                    <option value="4ft 10in/147.32cm">4ft 10in/147.32cm</option>
                    <option value="4ft 11in/149.86cm">4ft 11in/149.86cm</option>
                    <option value="5ft 0in/152.40cm">5ft 0in/152.40cm</option>
                    <option value="5ft 1in/154.94cm">5ft 1in/154.94cm</option>
                    <option value="5ft 2in/157.48cm">5ft 2in/157.48cm</option>
                    <option value="5ft 3in/160.02cm">5ft 3in/160.02cm</option>
                    <option value="5ft 4in/162.56cm">5ft 4in/162.56cm</option>
                    <option value="5ft 5in/165.10cm">5ft 5in/165.10cm</option>
                    <option value="5ft 6in/167.64cm">5ft 6in/167.64cm</option>
                    <option value="5ft 7in/170.18cm">5ft 7in/170.18cm</option>
                    <option value="5ft 8in/172.72cm">5ft 8in/172.72cm</option>
                    <option value="5ft 9in/175.26cm">5ft 9in/175.26cm</option>
                    <option value="5ft 10in/177.80cm">5ft 10in/177.80cm</option>
                    <option value="5ft 11in/180.34cm">5ft 11in/180.34cm</option>
                    <option value="6ft 0in/182.88cm">6ft 0in/182.88cm</option>
                    <option value="6ft 1in/185.42cm">6ft 1in/185.42cm</option>
                    <option value="6ft 2in/187.96cm">6ft 2in/187.96cm</option>
                    <option value="6ft 3in/190.50cm">6ft 3in/190.50cm</option>
                    <option value="6ft 4in/193.04cm">6ft 4in/193.04cm</option>
                    <option value="6ft 5in/195.58cm">6ft 5in/195.58cm</option>
                    <option value="6ft 6in/198.12cm">6ft 6in/198.12cm</option>
                    <option value="6ft 7in/200.66cm">6ft 7in/200.66cm</option>
                    <option value="6ft 8in/203.20cm">6ft 8in/203.20cm</option>
                </select>
												</div>
											</div>
											<div class="paddright ">
												...
												<div class="col-md-10 input-padding">
													<input type="text" class="input-style" id="" name="user_age" required>
											...
											<div class="paddright ">
												...
												<div class="col-md-10 input-padding">
													<input type="text" class="input-style" id="" name="user_weight" required>
												...
												<div class="paddright">
													...
													<div class="col-md-10 input-padding">
														<select required class="selectpicker form-control bs-select-hidden" name="caste">
	                        ...
	                        <option value="sc/st">sc/st</option>
												...
												<div class="paddright">
													...
													<div class="col-md-10 input-padding">
														<select required class="selectpicker form-control bs-select-hidden" name="sub_caste">
	                    <option value="">Select Caste</option>
	                    <option value="Teli">Teli</option>
	                    <option value="obc">obc</option>
	                    <option value="sc/st">sc/st</option>
												...
												<div class="paddright">
													...
													<div class="col-md-10 input-padding">
														<input type="radio" id="A1" name="A" value="Eggetarian" required><label for="A1">Eggetarian</label>
												...
												<div class="paddright">
													...
													<div class="col-md-10 input-padding">
														<input type="radio" id="A4" name="B" value="Yes" required><label for="A4">Yes</label>
												...
												<div class="paddright">
													...
													<div class="col-md-10 input-padding">
														<input type="radio" id="A7" name="C" value="Yes" required><label for="A7">Yes</label>
												...
												<div class="paddright">
													...
													<div class="col-md-10 input-padding">
														<input type="radio" id="A10" name="D" value="Normal" required><label for="A10">Normal</label>
						...
						<div class="terms">
							...
							<div class="mainbox">
									...
									<div class="container">
										<div class="row" style="width:75%; margin-top: -34px">
											<div class="paddright">
												...
												<div class="col-md-10 input-padding">
													<select required class="selectpicker form-control" name="star">
								...
								<option value="Meen - Pisces">Meen - Pisces</option>
                                        ...
                                        <div class="col-md-10 input-padding">
                                            <input type="radio" id="A30" name="J" value="Yes"><label for="A30">Yes</label>
                                            <input type="radio" id="A31" name="J" value="No"><label for="A31">No</label>
                                            <input type="radio" id="A32" name="J" value="Does not Matter"><label for="A32">Does not Matter</label>
                                    </div>
                                    </div>
											<div class="paddright">
                      ...
                      <option value="Agricultural Science (AS)">Agricultural Science (AS)</option>
                        ...
                        <option value="Nursing Assistants">Nursing Assistants</option>
											...
											<div class="paddright">
												...
												<div class="col-md-10 input-padding">
													<input type="text" class="form-control input-style" name="income" id="State" placeholder="income">
												</div>
			...
			<div class="container">
				<div class="row">
					...
					<input type="text" class="form-control input-style"  name="phone_no" id="mobile" placeholder="Mobile Number"></textarea>
					 ...
					 <div class="paddright">
					 <div class="col-md-2"><span>Ancestral/Family origin</span></div>
					
					 <div class="col-md-10 input-padding">
					<input type="text" class="form-control input-style"  name="family_origin" id="family_origin" placeholder="Family Origin"></textarea>
				 </div>
					 </div>
