...
$partner_martial_status=addslashes($_POST["Z"]);
$partner_physical_status=addslashes($_POST["Y"]);
$partner_eating_habits=addslashes($_POST["X"]);
$partner_drinking_habits=addslashes($_POST["W"]);
$partner_smoking_habits=addslashes($_POST["V"]);
...
$partner_manglik=addslashes($_POST["U"]);
						...
						<div class="row" style="width:75%; margin-top: -34px">
                            ...
                            <div class="paddright">
								...
								<div class="col-md-10 input-padding">
                                    ...
                                    <input type="radio" id="radio40" name="Y" value="Does not Matter"><label for="radio40">Does not Matter</label>
                             </div>
                            </div>
                            <div class="paddright">
								...
								<div class="col-md-10 input-padding">
                                    ...
                                    <input type="radio" id="radio44" name="X" value="Does not Matter"><label for="radio44">Does not Matter</label>
                             </div>
                            </div>
                            <div class="paddright">
								<div class="col-md-2"><span>Drinking Habits<sup class="top-sup">*</sup></span></div>
								<div class="col-md-10 input-padding">
                                    <input type="radio" id="radio45" name="W" value="Does not Matter"><label for="radio45">Does not Matter</label>
                            ...
                            <div class="paddright">
								...
								<div class="col-md-10 input-padding">
                                    <input type="radio" id="radio49" name="V" value="Does not Matter"><label for="radio49">Does not Matter</label>
                                ...
                                <div class="paddright">
                                    ...
                                    <div class="paddright">
                                        ...
                                        <div class="col-md-10 input-padding">
                                            ...
                                            <input type="radio" id="radio55" name="U" value="Does not Matter"><label for="radio55">Does not Matter</label>
                                    </div>
                                    </div>
						</div>
</div>
...
<div class="commontop">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12 wrapper1 ">
        ...
        <button type="submit" name="submit" class="button1 btn btn-primary" style="margin-top: 14px;" value="Complete Registration">Save & Proceed</button>
    </form>
    </div>
	</div>
