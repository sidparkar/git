				...
				<div class="dashboard">
					<div class="profile">
											<div class="col-sm-3 col-xs-12">
												<img class="img-responsive profile-img" src="images/dashboard/dp.png" alt="image" title="image">
											...
											<div class="col-sm-9 col-xs-12 padd0">
												<h4>John Doe</h4>
												<div class="common">
													<p class="info">Mumbai, Maharashtra, India</p>												
													<p class="info">32 Yrs, 4 Ft 8  In / 142 Cms</p>
													<p class="info">Hindu, Teli (Caste No Bar)</p>													
													<p class="info">BCA, Manager</p>
